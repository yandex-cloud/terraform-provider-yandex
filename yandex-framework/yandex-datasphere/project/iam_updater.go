...
func newProjectIamUpdater() iam_binging.ResourceIamUpdater {
...
func (u *ProjectIAMUpdater) Initialize(ctx context.Context, state iam_binging.Extractable, diag *diag.Diagnostics) {
	var id types.String
	diag.Append(state.GetAttribute(ctx, path.Root("project_id"), &id)...)
	u.ProjectId = id.ValueString()
}

func (u *ProjectIAMUpdater) GetResourceIamPolicy(ctx context.Context) (*iam_binging.Policy, error) {
...
func (u *ProjectIAMUpdater) SetResourceIamPolicy(ctx context.Context, policy *iam_binging.Policy) error {
...
func (u *ProjectIAMUpdater) UpdateResourceIamPolicy(ctx context.Context, policy *iam_binging.PolicyDelta) error {
	bSize := 1000
