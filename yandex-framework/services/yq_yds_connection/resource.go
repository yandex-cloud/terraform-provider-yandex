...
func (r *ydsConnectionStrategy) ExpandSetting(ctx context.Context, sdk *ycsdk.SDK, plan *tfsdk.Plan, diagnostics *diag.Diagnostics) *Ydb_FederatedQuery.ConnectionSetting {
