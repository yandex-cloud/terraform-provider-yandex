...
type ClickhouseConfig struct {
	...
	VectorSimilarityIndexCacheSize              types.Int64   `tfsdk:"vector_similarity_index_cache_size"`
	VectorSimilarityIndexCacheMaxEntries        types.Int64   `tfsdk:"vector_similarity_index_cache_max_entries"`
	MaxBuildVectorSimilarityIndexThreadPoolSize types.Int64   `tfsdk:"max_build_vector_similarity_index_thread_pool_size"`
...
var ClickhouseConfigAttrTypes = map[string]attr.Type{
	...
	"mark_cache_size":                                    types.Int64Type,
	"vector_similarity_index_cache_size":                 types.Int64Type,
	"vector_similarity_index_cache_max_entries":          types.Int64Type,
	"max_build_vector_similarity_index_thread_pool_size": types.Int64Type,
	"tls": types.ObjectType{AttrTypes: ClickhouseTlsAttrTypes},
}

func FlattenClickHouseConfig(ctx context.Context, prevClickHouse types.Object, config *clickhouseConfig.ClickhouseConfig, tlsOverride *clickhouseConfig.ClickhouseConfig_Tls, diags *diag.Diagnostics) types.Object {
	if config == nil {
	...
	obj, d := types.ObjectValueFrom(
		ctx, ClickhouseConfigAttrTypes, ClickhouseConfig{
			...
			MarkCacheSize:                               mdbcommon.FlattenInt64Wrapper(ctx, config.MarkCacheSize, diags),
			VectorSimilarityIndexCacheSize:              mdbcommon.FlattenInt64Wrapper(ctx, config.VectorSimilarityIndexCacheSize, diags),
			VectorSimilarityIndexCacheMaxEntries:        mdbcommon.FlattenInt64Wrapper(ctx, config.VectorSimilarityIndexCacheMaxEntries, diags),
			MaxBuildVectorSimilarityIndexThreadPoolSize: mdbcommon.FlattenInt64Wrapper(ctx, config.MaxBuildVectorSimilarityIndexThreadPoolSize, diags),
			Tls: flattenClickhouseTls(ctx, tlsOverride, diags),
		},
	)
	diags.Append(d...)
...
func ExpandClickHouseConfig(ctx context.Context, c types.Object, diags *diag.Diagnostics) *clickhouseConfig.ClickhouseConfig {
	...
	return &clickhouseConfig.ClickhouseConfig{
		...
		MarkCacheSize:                               mdbcommon.ExpandInt64Wrapper(ctx, config.MarkCacheSize, diags),
		VectorSimilarityIndexCacheSize:              mdbcommon.ExpandInt64Wrapper(ctx, config.VectorSimilarityIndexCacheSize, diags),
		VectorSimilarityIndexCacheMaxEntries:        mdbcommon.ExpandInt64Wrapper(ctx, config.VectorSimilarityIndexCacheMaxEntries, diags),
		MaxBuildVectorSimilarityIndexThreadPoolSize: mdbcommon.ExpandInt64Wrapper(ctx, config.MaxBuildVectorSimilarityIndexThreadPoolSize, diags),
		Tls: expandClickhouseTls(ctx, config.Tls, diags),
	}
}
