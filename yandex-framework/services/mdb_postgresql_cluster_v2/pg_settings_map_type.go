...
func pgSharedPreloadLibrariesEnumNames() map[int32]string {
	...
	maps.Copy(namesMap, config.PostgresqlConfig19_SharedPreloadLibraries_name)
	maps.Copy(namesMap, config.PostgresqlConfig19_1C_SharedPreloadLibraries_name)
	return namesMap
}
...
func pgSharedPreloadLibrariesEnumValues() map[string]int32 {
	kek := MergeMaps(
		...
		config.PostgresqlConfig19_SharedPreloadLibraries_value,
		config.PostgresqlConfig19_1C_SharedPreloadLibraries_value,
	)
	return kek
}
