...
var _ datasource.DataSourceWithConfigure = (*yandexOrganizationmanagerIdpUserpoolDataSource)(nil)

type yandexOrganizationmanagerIdpUserpoolDataSource struct {
	providerConfig *provider_config.Config
}

func NewDataSource() datasource.DataSource {
	return &yandexOrganizationmanagerIdpUserpoolDataSource{}
}

func (r *yandexOrganizationmanagerIdpUserpoolDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = "yandex_organizationmanager_idp_userpool"
}

func (r *yandexOrganizationmanagerIdpUserpoolDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *yandexOrganizationmanagerIdpUserpoolDataSource) Schema(ctx context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = YandexOrganizationmanagerIdpUserpoolDatasourceSchema(ctx)
}

func (r *yandexOrganizationmanagerIdpUserpoolDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var state yandexOrganizationmanagerIdpUserpoolDatasourceModel
	...
	newState := flattenYandexOrganizationmanagerIdpUserpoolDatasource(ctx, res, state, state.Timeouts, &resp.Diagnostics)
	if resp.Diagnostics.HasError() {
		return
	}
