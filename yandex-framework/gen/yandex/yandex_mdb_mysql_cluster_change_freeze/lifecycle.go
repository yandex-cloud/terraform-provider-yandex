...
var _ resource.ResourceWithModifyPlan = (*yandexMdbMysqlClusterChangeFreezeResource)(nil)

func (r *yandexMdbMysqlClusterChangeFreezeResource) ModifyPlan(ctx context.Context, req resource.ModifyPlanRequest, resp *resource.ModifyPlanResponse) {
