...
var _ resource.ResourceWithModifyPlan = (*yandexAirflowClusterChangeFreezeResource)(nil)

func (r *yandexAirflowClusterChangeFreezeResource) ModifyPlan(ctx context.Context, req resource.ModifyPlanRequest, resp *resource.ModifyPlanResponse) {
