package yandex_spark_cluster_change_freeze
...
var _ resource.ResourceWithModifyPlan = (*yandexSparkClusterChangeFreezeResource)(nil)

func (r *yandexSparkClusterChangeFreezeResource) ModifyPlan(ctx context.Context, req resource.ModifyPlanRequest, resp *resource.ModifyPlanResponse) {
