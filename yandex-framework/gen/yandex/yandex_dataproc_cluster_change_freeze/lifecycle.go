...
var _ resource.ResourceWithModifyPlan = (*yandexDataprocClusterChangeFreezeResource)(nil)

func (r *yandexDataprocClusterChangeFreezeResource) ModifyPlan(ctx context.Context, req resource.ModifyPlanRequest, resp *resource.ModifyPlanResponse) {
