...
var _ resource.ResourceWithModifyPlan = (*yandexMdbMongodbClusterChangeFreezeResource)(nil)

func (r *yandexMdbMongodbClusterChangeFreezeResource) ModifyPlan(ctx context.Context, req resource.ModifyPlanRequest, resp *resource.ModifyPlanResponse) {
