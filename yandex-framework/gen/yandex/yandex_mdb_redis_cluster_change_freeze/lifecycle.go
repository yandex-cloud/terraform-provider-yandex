...
var _ resource.ResourceWithModifyPlan = (*yandexMdbRedisClusterChangeFreezeResource)(nil)

func (r *yandexMdbRedisClusterChangeFreezeResource) ModifyPlan(ctx context.Context, req resource.ModifyPlanRequest, resp *resource.ModifyPlanResponse) {
