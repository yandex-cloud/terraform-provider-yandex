...
var _ resource.ResourceWithModifyPlan = (*yandexTrinoClusterChangeFreezeResource)(nil)

func (r *yandexTrinoClusterChangeFreezeResource) ModifyPlan(ctx context.Context, req resource.ModifyPlanRequest, resp *resource.ModifyPlanResponse) {
