...
var _ resource.ResourceWithModifyPlan = (*yandexMetastoreClusterChangeFreezeResource)(nil)

func (r *yandexMetastoreClusterChangeFreezeResource) ModifyPlan(ctx context.Context, req resource.ModifyPlanRequest, resp *resource.ModifyPlanResponse) {
