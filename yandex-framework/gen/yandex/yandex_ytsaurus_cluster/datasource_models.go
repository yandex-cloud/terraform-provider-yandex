...
func (m *yandexYtsaurusClusterDatasourceModel) GetCidrBlocksWhitelist() types.Object {
	return m.CidrBlocksWhitelist
}
func (m *yandexYtsaurusClusterDatasourceModel) GetClusterId() types.String {
	return m.ClusterId
}
func (m *yandexYtsaurusClusterDatasourceModel) GetID() types.String {
	return m.ID
}
func (m *yandexYtsaurusClusterDatasourceModel) GetCreatedAt() types.String {
	return m.CreatedAt
}
func (m *yandexYtsaurusClusterDatasourceModel) GetCreatedBy() types.String {
	return m.CreatedBy
}
func (m *yandexYtsaurusClusterDatasourceModel) GetDescription() types.String {
	return m.Description
}
func (m *yandexYtsaurusClusterDatasourceModel) GetEndpoints() types.Object {
	return m.Endpoints
}
func (m *yandexYtsaurusClusterDatasourceModel) GetFolderId() types.String {
	return m.FolderId
}
func (m *yandexYtsaurusClusterDatasourceModel) GetHealth() types.String {
	return m.Health
}
...
func (m *yandexYtsaurusClusterDatasourceModel) GetSecurityGroupIds() types.List {
	return m.SecurityGroupIds
}
func (m *yandexYtsaurusClusterDatasourceModel) GetSpec() types.Object {
	return m.Spec
}
func (m *yandexYtsaurusClusterDatasourceModel) GetStatus() types.String {
	return m.Status
}
func (m *yandexYtsaurusClusterDatasourceModel) GetSubnetId() types.String {
	return m.SubnetId
}
func (m *yandexYtsaurusClusterDatasourceModel) GetUpdatedAt() types.String {
	return m.UpdatedAt
}
func (m *yandexYtsaurusClusterDatasourceModel) GetUpdatedBy() types.String {
	return m.UpdatedBy
}
func (m *yandexYtsaurusClusterDatasourceModel) GetZoneId() types.String {
	return m.ZoneId
}
...
func flattenYandexYtsaurusClusterDatasource(ctx context.Context,
	...
	value, diag := types.ObjectValueFrom(ctx, yandexYtsaurusClusterDatasourceModelType.AttrTypes, yandexYtsaurusClusterDatasourceModel{
		CidrBlocksWhitelist: flattenYandexYtsaurusClusterCidrBlocksWhitelist(ctx, yandexYtsaurusClusterDatasource.GetCidrBlocksWhitelist(), converter.ExpandObject(ctx, state.CidrBlocksWhitelist, yandexYtsaurusClusterCidrBlocksWhitelistModel{}, diags).(yandexYtsaurusClusterCidrBlocksWhitelistModel), diags),
