...
var _ resource.ResourceWithModifyPlan = (*yandexMdbGreenplumClusterChangeFreezeResource)(nil)

func (r *yandexMdbGreenplumClusterChangeFreezeResource) ModifyPlan(ctx context.Context, req resource.ModifyPlanRequest, resp *resource.ModifyPlanResponse) {
