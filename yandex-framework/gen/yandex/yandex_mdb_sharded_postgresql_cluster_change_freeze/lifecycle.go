...
var _ resource.ResourceWithModifyPlan = (*yandexMdbShardedPostgresqlClusterChangeFreezeResource)(nil)

func (r *yandexMdbShardedPostgresqlClusterChangeFreezeResource) ModifyPlan(ctx context.Context, req resource.ModifyPlanRequest, resp *resource.ModifyPlanResponse) {
