...
- `address_id` (*Read-Only*) (String). ID of the address resource.
- `created_at` (*Read-Only*) (String). Creation timestamp.
- `deletion_protection` (*Read-Only*) (Bool). Prevents accidental endpoint removal.
...
- `network_id` (*Read-Only*) (String). ID of the network that the DNS inbound endpoint belongs to.
