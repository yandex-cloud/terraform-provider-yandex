...
- `allowed_sites` (*Read-Only*) (List Of String). List of allowed host names, see [Domain validation](/docs/smartcaptcha/concepts/domain-validation).
...
- `turn_off_hostname_check` (*Read-Only*) (Bool). Turn off host name check, see [Domain validation](/docs/smartcaptcha/concepts/domain-validation).
- `timeouts` [Block]. 
