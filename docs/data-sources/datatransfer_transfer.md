...
filename: yandex/cloud/datatransfer/v1/transfer.proto
  ...
  - `include_objects` (*Read-Only*) (List Of String). package: yandex.cloud.datatransfer.v1
filename: yandex/cloud/datatransfer/v1/transfer.proto
...
filename: yandex/cloud/datatransfer/v1/transfer.proto
    ...
    - `cron_expression` (*Read-Only*) (String). Use a cron expression to schedule transfer regular snapshots in UTC time.
 ...
 only one of schedule or cron_expression should be set
    - `increment_delay_seconds` (*Read-Only*) (Number). Wait for transaction completion time, in seconds
 ...
 actually guarantee the order
    - `retry_config` [Block]. Regular snapshot retries, only for cloud installation
      - `max_attempts` (*Read-Only*) (Number). Number of attempts to retry regular snapshot in case of failure. Applicable only
 ...
 based on cursor column value.
      - `cursor_column` (*Read-Only*) (String). package: yandex.cloud.datatransfer.v1
filename: yandex/cloud/datatransfer/v1/transfer.proto

      - `initial_state` (*Read-Only*) (String). package: yandex.cloud.datatransfer.v1
filename: yandex/cloud/datatransfer/v1/transfer.proto

      - `table_name` (*Read-Only*) (String). package: yandex.cloud.datatransfer.v1
filename: yandex/cloud/datatransfer/v1/transfer.proto

      - `table_namespace` (*Read-Only*) (String). package: yandex.cloud.datatransfer.v1
filename: yandex/cloud/datatransfer/v1/transfer.proto
...
filename: yandex/cloud/datatransfer/v1/transfer.proto
    ...
    - `job_count` (*Read-Only*) (Number). Number of workers in parallel replication.
    - `upload_shard_params` [Block]. Parallel snapshot parameters
      - `job_count` (*Read-Only*) (Number). Number of workers.
      - `process_count` (*Read-Only*) (Number). Number of threads.
 ...
 Transformers are applied to the tables in the sequence specified in the list.
    - `convert_to_string` [Block]. Convert column values to strings
      - `columns` [Block]. List of included and excluded columns
        - `exclude_columns` (*Read-Only*) (List Of String). List of columns that will be excluded to transfer
        - `include_columns` (*Read-Only*) (List Of String). List of columns that will be included to transfer
      - `skip_utc_conversion` (*Read-Only*) (Bool). When true, time values keep their original timezone, otherwise time values converts (normalizes) to UTC.
      - `tables` [Block]. List of included and excluded tables
        - `exclude_tables` (*Read-Only*) (List Of String). List of tables that will be excluded to transfer
        - `include_tables` (*Read-Only*) (List Of String). List of tables that will be included to transfer
    ...
    - `mask_field` [Block]. Mask field transformer allows you to hash data
      ...
      - `function` [Block]. Mask function
        - `mask_function_hash` [Block]. Hash mask function
          - `user_defined_salt` (*Read-Only*) (String). This string will be used in the HMAC(sha256, salt) function applied to the
 column data.
      - `tables` [Block]. List of included and excluded tables
        - `exclude_tables` (*Read-Only*) (List Of String). List of tables that will be excluded to transfer
        - `include_tables` (*Read-Only*) (List Of String). List of tables that will be included to transfer
...
filename: yandex/cloud/datatransfer/v1/transfer.proto
          ...
          - `name_space` (*Read-Only*) (String). package: yandex.cloud.datatransfer.v1
filename: yandex/cloud/datatransfer/v1/transfer.proto
...
filename: yandex/cloud/datatransfer/v1/transfer.proto
      ...
      - `shards_count` (*Read-Only*) (Number). Number of shards
      - `tables` [Block]. List of included and excluded tables
        - `exclude_tables` (*Read-Only*) (List Of String). List of tables that will be excluded to transfer
        - `include_tables` (*Read-Only*) (List Of String). List of tables that will be included to transfer
