...
# yandex_serverless_container_iam_member (Resource)
...
- `role` (**Required**)(String). The role that should be assigned. Only one yandex_serverless_container_iam_member can be used per role.
