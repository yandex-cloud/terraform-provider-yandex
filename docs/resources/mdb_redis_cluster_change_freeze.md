...
# yandex_mdb_redis_cluster_change_freeze (Resource)
...
```terraform
resource "yandex_mdb_redis_cluster_change_freeze" "example" {
  resource_id = yandex_mdb_redis_cluster.example.id
...
terraform import yandex_mdb_redis_cluster_change_freeze.example c9q-resource-id:change-freeze-id
```
