...
~> **Note**: Alternatively, you can provide [static access keys](https://cloud.yandex.com/docs/iam/concepts/authorization/access-key) (Access and Secret) to create a storage client for working with the Storage Service. To generate these keys, you will need a Service Account with the appropriate permissions.
