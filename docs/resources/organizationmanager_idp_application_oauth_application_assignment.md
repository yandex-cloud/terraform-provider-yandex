...
page_title: "Yandex: yandex_organizationmanager_idp_application_oauth_application_assignment"
description: |-
  Allows management of OAuth application assignments for a Yandex Organization Manager Identity Provider.
---
