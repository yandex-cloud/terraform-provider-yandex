...
- `config` [FW-Block]. Configuration of the Spark cluster.
  - `dependencies` [FW-Block]. Environment dependencies.
  ...
  - `history_server` [FW-Block]. History Server configuration.
  ...
  - `resource_pools` [FW-Block]. Computational resources.
    - `driver` [FW-Block]. Computational resources for the driver pool.
    ...
    - `executor` [FW-Block]. Computational resources for the executor pool.
...
- `maintenance_window` [FW-Block]. Configuration of the window for maintenance operations.
...
- `network` [FW-Block]. Network configuration.
