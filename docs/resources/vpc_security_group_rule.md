...
You can get `security_group_rule id` from `yc vpc security-group get <security_group_id>`.

```bash
# terraform import yandex_vpc_security_group.<resource Name> <security_group_id>:<resource Id>
