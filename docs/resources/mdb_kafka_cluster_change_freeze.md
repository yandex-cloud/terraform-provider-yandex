...
# yandex_mdb_kafka_cluster_change_freeze (Resource)
...
```terraform
resource "yandex_mdb_kafka_cluster_change_freeze" "example" {
  resource_id = yandex_mdb_kafka_cluster.example.id
...
terraform import yandex_mdb_kafka_cluster_change_freeze.example c9q-resource-id:change-freeze-id
```
