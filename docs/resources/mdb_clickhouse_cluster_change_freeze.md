...
# yandex_mdb_clickhouse_cluster_change_freeze (Resource)
...
terraform import yandex_mdb_clickhouse_cluster_change_freeze.example c9q-resource-id:change-freeze-id
```
