...
sidebar_current: "docs-yandex-vpc-private-endpoint"
description: |-
...
Manages a VPC Private Endpoint within the Yandex.Cloud. For more information, see
[the official documentation](https://cloud.yandex.com/en/docs/vpc/concepts/private-endpoint).
