...
require (
	...
	github.com/yandex-cloud/go-sdk/services/datacatalog v0.0.2
	...
	github.com/yandex-cloud/go-sdk/services/smartcaptcha v0.0.80
	github.com/yandex-cloud/go-sdk/services/smartwebsecurity v0.0.77
