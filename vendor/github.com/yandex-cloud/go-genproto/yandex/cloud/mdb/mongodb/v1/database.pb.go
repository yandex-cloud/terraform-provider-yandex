...
func (*Database) Descriptor() ([]byte, []int) {
	return fileDescriptor_database_94eabe15d4a5734a, []int{0}
}
...
func (*DatabaseSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_database_94eabe15d4a5734a, []int{1}
}
...
func init() {
	proto.RegisterFile("yandex/cloud/mdb/mongodb/v1/database.proto", fileDescriptor_database_94eabe15d4a5734a)
}

var fileDescriptor_database_94eabe15d4a5734a = []byte{
