...
const (
	...
	//
	// Deprecated: Marked as deprecated in yandex/cloud/mdb/postgresql/v1/config/postgresql16_1c.proto.
...
type PostgresqlConfig16_1C struct {
	...
	PasswordEncryption PostgresqlConfig16_1C_PasswordEncryption `protobuf:"varint,167,opt,name=password_encryption,json=passwordEncryption,proto3,enum=yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16_1C_PasswordEncryption" json:"password_encryption,omitempty"`
	...
	AutoExplainLogFormat PostgresqlConfig16_1C_AutoExplainLogFormat `protobuf:"varint,168,opt,name=auto_explain_log_format,json=autoExplainLogFormat,proto3,enum=yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16_1C_AutoExplainLogFormat" json:"auto_explain_log_format,omitempty"`
	...
	PgHintPlanHintsAnywhere *wrapperspb.BoolValue `protobuf:"bytes,175,opt,name=pg_hint_plan_hints_anywhere,json=pgHintPlanHintsAnywhere,proto3" json:"pg_hint_plan_hints_anywhere,omitempty"`
...
const file_yandex_cloud_mdb_postgresql_v1_config_postgresql16_1c_proto_rawDesc = "" +
	"\n" +
	";yandex/cloud/mdb/postgresql/v1/config/postgresql16_1c.proto\x12%yandex.cloud.mdb.postgresql.v1.config\x1a\x1egoogle/protobuf/wrappers.proto\x1a\x1dyandex/cloud/validation.proto\"\x8e\x90\x01\n" +
