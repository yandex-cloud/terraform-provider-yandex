...
const (
	...
	//
	// Deprecated: Marked as deprecated in yandex/cloud/mdb/postgresql/v1/config/postgresql16.proto.
...
type PostgresqlConfig16 struct {
	...
	PasswordEncryption PostgresqlConfig16_PasswordEncryption `protobuf:"varint,167,opt,name=password_encryption,json=passwordEncryption,proto3,enum=yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16_PasswordEncryption" json:"password_encryption,omitempty"`
	...
	AutoExplainLogFormat PostgresqlConfig16_AutoExplainLogFormat `protobuf:"varint,168,opt,name=auto_explain_log_format,json=autoExplainLogFormat,proto3,enum=yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16_AutoExplainLogFormat" json:"auto_explain_log_format,omitempty"`
...
const file_yandex_cloud_mdb_postgresql_v1_config_postgresql16_proto_rawDesc = "" +
	"\n" +
	"8yandex/cloud/mdb/postgresql/v1/config/postgresql16.proto\x12%yandex.cloud.mdb.postgresql.v1.config\x1a\x1egoogle/protobuf/wrappers.proto\x1a\x1dyandex/cloud/validation.proto\"\xac\x8e\x01\n" +
