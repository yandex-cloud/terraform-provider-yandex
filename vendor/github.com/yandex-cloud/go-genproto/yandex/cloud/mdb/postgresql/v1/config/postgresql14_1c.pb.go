...
const (
	...
	//
	// Deprecated: Marked as deprecated in yandex/cloud/mdb/postgresql/v1/config/postgresql14_1c.proto.
...
type PostgresqlConfig14_1C struct {
	...
	PasswordEncryption PostgresqlConfig14_1C_PasswordEncryption `protobuf:"varint,167,opt,name=password_encryption,json=passwordEncryption,proto3,enum=yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C_PasswordEncryption" json:"password_encryption,omitempty"`
	...
	AutoExplainLogFormat PostgresqlConfig14_1C_AutoExplainLogFormat `protobuf:"varint,168,opt,name=auto_explain_log_format,json=autoExplainLogFormat,proto3,enum=yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C_AutoExplainLogFormat" json:"auto_explain_log_format,omitempty"`
...
const file_yandex_cloud_mdb_postgresql_v1_config_postgresql14_1c_proto_rawDesc = "" +
	"\n" +
	";yandex/cloud/mdb/postgresql/v1/config/postgresql14_1c.proto\x12%yandex.cloud.mdb.postgresql.v1.config\x1a\x1egoogle/protobuf/wrappers.proto\x1a\x1dyandex/cloud/validation.proto\"\xa4\x8d\x01\n" +
