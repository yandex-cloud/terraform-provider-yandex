...
func (m *ConfigSpec) SetPostgresqlConfig_19(v *config.PostgresqlConfig19) {
	m.PostgresqlConfig = &ConfigSpec_PostgresqlConfig_19{
		PostgresqlConfig_19: v,
	}
}

func (m *ConfigSpec) SetPostgresqlConfig_19_1C(v *config.PostgresqlConfig19_1C) {
	m.PostgresqlConfig = &ConfigSpec_PostgresqlConfig_19_1C{
...
func (m *ConfigHostSpec) SetPostgresqlConfig_19(v *config.PostgresqlHostConfig19) {
	m.PostgresqlConfig = &ConfigHostSpec_PostgresqlConfig_19{
		PostgresqlConfig_19: v,
	}
}

func (m *ConfigHostSpec) SetPostgresqlConfig_19_1C(v *config.PostgresqlHostConfig19_1C) {
	m.PostgresqlConfig = &ConfigHostSpec_PostgresqlConfig_19_1C{
		PostgresqlConfig_19_1C: v,
	}
}
