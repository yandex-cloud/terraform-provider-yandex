...
const (
	MaintenanceService_List_FullMethodName       = "/yandex.cloud.mdb.redis.v1.MaintenanceService/List"
	MaintenanceService_Get_FullMethodName        = "/yandex.cloud.mdb.redis.v1.MaintenanceService/Get"
	MaintenanceService_Reschedule_FullMethodName = "/yandex.cloud.mdb.redis.v1.MaintenanceService/Reschedule"
)
...
var MaintenanceService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "yandex.cloud.mdb.redis.v1.MaintenanceService",
	...
	Metadata: "yandex/cloud/mdb/redis/v1/maintenance_service.proto",
}
