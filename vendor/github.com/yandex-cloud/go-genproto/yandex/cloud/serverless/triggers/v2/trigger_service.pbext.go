...
func (m *CreateTriggerRequest) SetSource(v *Source) {
	m.Source = v
}

func (m *CreateTriggerRequest) SetAction(v []*Action) {
	m.Action = v
}
...
func (m *UpdateTriggerRequest) SetSource(v *Source) {
	m.Source = v
}

func (m *UpdateTriggerRequest) SetAction(v []*Action) {
	m.Action = v
}
