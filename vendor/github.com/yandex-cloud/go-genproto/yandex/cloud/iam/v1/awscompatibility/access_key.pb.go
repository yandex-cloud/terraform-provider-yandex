...
// For more information, see [Static Credentials](/iam/concepts/users/service-accounts#static-credentials).
...
func (*AccessKey) Descriptor() ([]byte, []int) {
	return fileDescriptor_access_key_39d8a5b0b4edfc88, []int{0}
}
...
func init() {
	proto.RegisterFile("yandex/cloud/iam/v1/awscompatibility/access_key.proto", fileDescriptor_access_key_39d8a5b0b4edfc88)
}

var fileDescriptor_access_key_39d8a5b0b4edfc88 = []byte{
