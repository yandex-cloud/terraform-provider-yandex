...
// MaintenanceClient provides methods for managing Maintenance resources of Yandex.Cloud Metastore.
...
// List is an operation of Yandex.Cloud Metastore Maintenance service.
func (c maintenanceClient) List(ctx context.Context, in *maintenance.ListMaintenancesRequest, opts ...grpc.CallOption) (*maintenance.ListMaintenancesResponse, error) {
	...
	return metastore.NewMaintenanceServiceClient(connection).List(ctx, in, opts...)
}

// Get is an operation of Yandex.Cloud Metastore Maintenance service.
func (c maintenanceClient) Get(ctx context.Context, in *maintenance.GetMaintenanceRequest, opts ...grpc.CallOption) (*maintenance.Maintenance, error) {
	...
	return metastore.NewMaintenanceServiceClient(connection).Get(ctx, in, opts...)
}
...
func (o *MaintenanceRescheduleOperation) Metadata() *metastore.RescheduleMaintenanceV2Metadata {
	return o.Operation.Metadata().(*metastore.RescheduleMaintenanceV2Metadata)
}
...
// Reschedule is an operation of Yandex.Cloud Metastore Maintenance service.
...
func (c maintenanceClient) Reschedule(ctx context.Context, in *maintenance.RescheduleMaintenanceRequest, opts ...grpc.CallOption) (*MaintenanceRescheduleOperation, error) {
	...
	pb, err := metastore.NewMaintenanceServiceClient(connection).Reschedule(ctx, in, opts...)
	if err != nil {
		return nil, err
	}
	op, err := sdkop.NewOperation(pb, &sdkop.Concretization{
		Poll:         c.pollOperation,
		MetadataType: (*metastore.RescheduleMaintenanceV2Metadata)(nil),
...
var (
	MaintenanceList            = protoreflect.FullName("yandex.cloud.metastore.v1.MaintenanceService.List")
	MaintenanceGet             = protoreflect.FullName("yandex.cloud.metastore.v1.MaintenanceService.Get")
	MaintenanceReschedule      = protoreflect.FullName("yandex.cloud.metastore.v1.MaintenanceService.Reschedule")
