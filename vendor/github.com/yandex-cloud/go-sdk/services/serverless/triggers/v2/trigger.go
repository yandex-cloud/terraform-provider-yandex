...
var (
	TriggerGet             = protoreflect.FullName("yandex.cloud.serverless.triggers.v2.TriggerService.Get")
	TriggerList            = protoreflect.FullName("yandex.cloud.serverless.triggers.v2.TriggerService.List")
	TriggerCreate          = protoreflect.FullName("yandex.cloud.serverless.triggers.v2.TriggerService.Create")
	TriggerUpdate          = protoreflect.FullName("yandex.cloud.serverless.triggers.v2.TriggerService.Update")
	TriggerDelete          = protoreflect.FullName("yandex.cloud.serverless.triggers.v2.TriggerService.Delete")
	TriggerPause           = protoreflect.FullName("yandex.cloud.serverless.triggers.v2.TriggerService.Pause")
	TriggerResume          = protoreflect.FullName("yandex.cloud.serverless.triggers.v2.TriggerService.Resume")
	TriggerListOperations  = protoreflect.FullName("yandex.cloud.serverless.triggers.v2.TriggerService.ListOperations")
