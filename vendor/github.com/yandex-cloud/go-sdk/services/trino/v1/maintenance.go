...
// MaintenanceClient provides methods for managing Maintenance resources of Yandex.Cloud Trino.
...
// List is an operation of Yandex.Cloud Trino Maintenance service.
func (c maintenanceClient) List(ctx context.Context, in *maintenance.ListMaintenancesRequest, opts ...grpc.CallOption) (*maintenance.ListMaintenancesResponse, error) {
	...
	return trino.NewMaintenanceServiceClient(connection).List(ctx, in, opts...)
}

// Get is an operation of Yandex.Cloud Trino Maintenance service.
func (c maintenanceClient) Get(ctx context.Context, in *maintenance.GetMaintenanceRequest, opts ...grpc.CallOption) (*maintenance.Maintenance, error) {
	...
	return trino.NewMaintenanceServiceClient(connection).Get(ctx, in, opts...)
}
...
func (o *MaintenanceRescheduleOperation) Metadata() *trino.RescheduleMaintenanceV2Metadata {
	return o.Operation.Metadata().(*trino.RescheduleMaintenanceV2Metadata)
}
...
// Reschedule is an operation of Yandex.Cloud Trino Maintenance service.
...
func (c maintenanceClient) Reschedule(ctx context.Context, in *maintenance.RescheduleMaintenanceRequest, opts ...grpc.CallOption) (*MaintenanceRescheduleOperation, error) {
	...
	pb, err := trino.NewMaintenanceServiceClient(connection).Reschedule(ctx, in, opts...)
	if err != nil {
		return nil, err
	}
	op, err := sdkop.NewOperation(pb, &sdkop.Concretization{
		Poll:         c.pollOperation,
		MetadataType: (*trino.RescheduleMaintenanceV2Metadata)(nil),
...
var (
	MaintenanceList            = protoreflect.FullName("yandex.cloud.trino.v1.MaintenanceService.List")
	MaintenanceGet             = protoreflect.FullName("yandex.cloud.trino.v1.MaintenanceService.Get")
	MaintenanceReschedule      = protoreflect.FullName("yandex.cloud.trino.v1.MaintenanceService.Reschedule")
