...
// MaintenanceClient provides methods for managing Maintenance resources of Yandex.Cloud MySQL.
...
// List is an operation of Yandex.Cloud MySQL Maintenance service.
func (c maintenanceClient) List(ctx context.Context, in *maintenance.ListMaintenancesRequest, opts ...grpc.CallOption) (*maintenance.ListMaintenancesResponse, error) {
	...
	return mysql.NewMaintenanceServiceClient(connection).List(ctx, in, opts...)
}

// Get is an operation of Yandex.Cloud MySQL Maintenance service.
func (c maintenanceClient) Get(ctx context.Context, in *maintenance.GetMaintenanceRequest, opts ...grpc.CallOption) (*maintenance.Maintenance, error) {
	...
	return mysql.NewMaintenanceServiceClient(connection).Get(ctx, in, opts...)
}
...
func (o *MaintenanceRescheduleOperation) Metadata() *mysql.RescheduleMaintenanceV2Metadata {
	return o.Operation.Metadata().(*mysql.RescheduleMaintenanceV2Metadata)
}
...
// Reschedule is an operation of Yandex.Cloud MySQL Maintenance service.
...
func (c maintenanceClient) Reschedule(ctx context.Context, in *maintenance.RescheduleMaintenanceRequest, opts ...grpc.CallOption) (*MaintenanceRescheduleOperation, error) {
	...
	pb, err := mysql.NewMaintenanceServiceClient(connection).Reschedule(ctx, in, opts...)
	if err != nil {
		return nil, err
	}
	op, err := sdkop.NewOperation(pb, &sdkop.Concretization{
		Poll:         c.pollOperation,
		MetadataType: (*mysql.RescheduleMaintenanceV2Metadata)(nil),
...
var (
	MaintenanceList            = protoreflect.FullName("yandex.cloud.mdb.mysql.v1.MaintenanceService.List")
	MaintenanceGet             = protoreflect.FullName("yandex.cloud.mdb.mysql.v1.MaintenanceService.Get")
	MaintenanceReschedule      = protoreflect.FullName("yandex.cloud.mdb.mysql.v1.MaintenanceService.Reschedule")
