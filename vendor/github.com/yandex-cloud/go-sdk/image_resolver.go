...
func ImageResolver(name string, opts ...ResolveOption) Resolver {
	return &imageResolver{
		BaseResolver: NewBaseResolver(name, opts...),
	}
}

func (r *imageResolver) Run(ctx context.Context, sdk *SDK, opts ...grpc.CallOption) error {
...
func ImageByFamilyResolver(name string, opts ...ResolveOption) Resolver {
	return &imageByFamilyResolver{
		BaseResolver: NewBaseResolver(name, opts...),
	}
}

func (r *imageByFamilyResolver) Run(ctx context.Context, sdk *SDK, opts ...grpc.CallOption) error {
