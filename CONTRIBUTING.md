...
In our work on this project we use [Changie](https://changie.dev/) to generate [CHANGELOG.md](CHANGELOG.md) automatically. Therefore we ask you to write down every new change using command `changie new` from the project root directory and commit new files in the `.changes/unreleased/` directory along with your code changes.
