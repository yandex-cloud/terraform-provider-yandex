...
func TestYandexDataSourceIoTRegistry_byID(t *testing.T) {
	t.Parallel()
...
func TestYandexDataSourceIoTRegistry_byName(t *testing.T) {
	t.Parallel()
...
func TestYandexDataSourceIoTCoreRegistry_full(t *testing.T) {
	t.Parallel()
