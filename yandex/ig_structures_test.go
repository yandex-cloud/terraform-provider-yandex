	...
	cases := []struct {
	...
	}{
		{
			...
			mo: &instancegroup.MetadataOptions{
				...
				AwsV2HttpEndpoint: instancegroup.MetadataOption_ENABLED,
				AwsV2HttpToken:    instancegroup.MetadataOption_ENABLED,
			},
			expected: []map[string]interface{}{{
				"gce_http_endpoint":    1,
		...
		},
		{
			...
			mo: &instancegroup.MetadataOptions{
				...
				AwsV2HttpEndpoint: instancegroup.MetadataOption_DISABLED,
				AwsV2HttpToken:    instancegroup.MetadataOption_DISABLED,
			},
			expected: []map[string]interface{}{{
				"gce_http_endpoint":    2,
