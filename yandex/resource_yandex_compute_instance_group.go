							...
							Elem: &schema.Resource{
								Schema: map[string]*schema.Schema{
									...
									"aws_v2_http_endpoint": {
										Type:         schema.TypeInt,
										Description:  "Enables access to AWS flavored metadata with session token (IMDSv2). Possible values: `0`, `1` for `enabled` and `2` for `disabled`.",
										ValidateFunc: validation.IntBetween(0, 2),
										Optional:     true,
										Computed:     true,
									},
									"aws_v2_http_token": {
										Type:         schema.TypeInt,
										Description:  "Enables access to STS credentials with AWS flavored metadata with session token (IMDSv2). Possible values: `0`, `1` for `enabled` and `2` for `disabled`.",
										ValidateFunc: validation.IntBetween(0, 2),
										Optional:     true,
										Computed:     true,
									},
