		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(dsgName, "ingress.2142518804.protocol", "TCP"),
					resource.TestCheckResourceAttr(dsgName, "ingress.2142518804.port", "8080"),
					resource.TestCheckResourceAttr(dsgName, "egress.4269128455.protocol", "ANY"),
					resource.TestCheckResourceAttr(dsgName, "egress.4269128455.port", "-1"),
					resource.TestCheckResourceAttr(dsgName, "egress.4269128455.from_port", "8090"),
					resource.TestCheckResourceAttr(dsgName, "egress.4269128455.to_port", "8099"),
