		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(dsgName, "ingress.3168776168.protocol", "TCP"),
					resource.TestCheckResourceAttr(dsgName, "ingress.3168776168.port", "8080"),
					resource.TestCheckResourceAttr(dsgName, "egress.740716492.protocol", "ANY"),
					resource.TestCheckResourceAttr(dsgName, "egress.740716492.port", "-1"),
					resource.TestCheckResourceAttr(dsgName, "egress.740716492.from_port", "8090"),
					resource.TestCheckResourceAttr(dsgName, "egress.740716492.to_port", "8099"),
