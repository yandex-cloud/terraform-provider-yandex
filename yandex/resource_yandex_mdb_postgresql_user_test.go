...
func TestAccMDBPostgreSQLUserPasswordWo(t *testing.T) {
	t.Parallel()
...
func TestAccMDBPostgreSQLUserPasswordConflict(t *testing.T) {
	t.Parallel()
...
func testAccCheckMDBPostgreSQLUserHasSettings(t *testing.T, username string, expected map[string]any) resource.TestCheckFunc {
	return func(s *terraform.State) error {
...
// Create user with password_wo (write-only password)
