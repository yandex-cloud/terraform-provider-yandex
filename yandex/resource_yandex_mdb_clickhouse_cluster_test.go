...
const (
	...
	chResourceSharded      = chResourceType + ".bar"
	chResourceCloudStorage = chResourceType + ".cloud"
	chResourceKeeper       = chResourceType + ".keeper"
...
func init() {
	resource.AddTestSweepers(chResourceType, &resource.Sweeper{
		Name: chResourceType,
		...
		Steps: []resource.TestStep{
			// Create ClickHouse Cluster with anytime maintenance_window
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckMDBClickHouseClusterExists(chResourceFoo, &r, 1),
					resource.TestCheckResourceAttr(chResourceFoo, "name", chName),
					resource.TestCheckResourceAttr(chResourceFoo, "folder_id", folderID),

					resource.TestCheckResourceAttr(chResourceFoo, "security_group_ids.#", "1"),
					resource.TestCheckResourceAttrSet(chResourceFoo, "service_account_id"),
					resource.TestCheckResourceAttrSet(chResourceFoo, "host.0.fqdn"),

					resource.TestCheckResourceAttr(chResourceFoo, "access.0.web_sql", "true"),
					resource.TestCheckResourceAttr(chResourceFoo, "access.0.data_lens", "true"),
					resource.TestCheckResourceAttr(chResourceFoo, "access.0.metrika", "true"),
					resource.TestCheckResourceAttr(chResourceFoo, "access.0.serverless", "true"),
					resource.TestCheckResourceAttr(chResourceFoo, "access.0.data_transfer", "true"),
					resource.TestCheckResourceAttr(chResourceFoo, "access.0.yandex_query", "true"),

					testAccCheckMDBClickHouseClusterContainsLabel(&r, "test_key", "test_value"),
					testAccCheckMDBClickHouseClusterHasUsers(chResourceFoo, map[string][]string{"john": {"testdb"}},
					...
					testAccCheckMDBClickHouseClusterHasDatabases(chResourceFoo, []string{"testdb"}),
					testAccCheckMDBClickHouseClusterHasFormatSchemas(chResourceFoo, map[string]map[string]string{}),
					...
					resource.TestCheckResourceAttr(chResourceFoo, "maintenance_window.0.type", "ANYTIME"),
					resource.TestCheckResourceAttr(chResourceFoo, "deletion_protection", "false"),
					resource.TestCheckResourceAttr(chResourceFoo, "backup_retain_period_days", "12"),
				),
			},
			...
			// Update ClickHouse Cluster with weekly maintenance_window
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					// testAccCheckMDBClickHouseClusterHasMlModels(chResource, map[string]map[string]string{}),
					testAccCheckCreatedAtAttr(chResourceFoo),
					resource.TestCheckResourceAttr(chResourceFoo, "maintenance_window.0.type", "WEEKLY"),
					resource.TestCheckResourceAttr(chResourceFoo, "maintenance_window.0.day", "FRI"),
					resource.TestCheckResourceAttr(chResourceFoo, "maintenance_window.0.hour", "20"),
					resource.TestCheckResourceAttr(chResourceFoo, "deletion_protection", "true"),
				),
			},
			mdbClickHouseClusterImportStep(chResourceFoo),
			...
			// Change some options
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(chResourceFoo, "security_group_ids.#", "2"),
					resource.TestCheckResourceAttrSet(chResourceFoo, "host.0.fqdn"),
					testAccCheckMDBClickHouseClusterContainsLabel(&r, "new_key", "new_value"),
					testAccCheckMDBClickHouseClusterHasUsers(chResourceFoo, map[string][]string{"john": {"testdb"}, "mary": {"newdb", "testdb"}},
						map[string]map[string]interface{}{
							"john": {
								"add_http_cors_header":          true,
					...
					testAccCheckMDBClickHouseClusterHasDatabases(chResourceFoo, []string{"testdb", "newdb"}),
					testAccCheckMDBClickHouseClusterHasFormatSchemas(chResourceFoo, map[string]map[string]string{
						"test_schema": {
					...
					testAccCheckCreatedAtAttr(chResourceFoo),
					resource.TestCheckResourceAttr(chResourceFoo, "maintenance_window.0.type", "ANYTIME"),
					resource.TestCheckResourceAttr(chResourceFoo, "cloud_storage.0.enabled", "true"),
					resource.TestCheckResourceAttr(chResourceFoo, "deletion_protection", "false"),
					resource.TestCheckResourceAttr(chResourceFoo, "backup_retain_period_days", "13"),
				),
			},
			mdbClickHouseClusterImportStep(chResourceFoo),
			...
			// Enable sql_user_management and sql_database_management - requires replacement
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttrSet(chResourceFoo, "host.0.fqdn"),
					testAccCheckMDBClickHouseClusterContainsLabel(&r, "test_key", "test_value"),
					testAccCheckMDBClickHouseClusterHasUsers(chResourceFoo, map[string][]string{}, map[string]map[string]interface{}{}, map[string][]map[string]interface{}{}),
					testAccCheckMDBClickHouseClusterHasDatabases(chResourceFoo, []string{}),
					testAccCheckCreatedAtAttr(chResourceFoo)),
			},
			mdbClickHouseClusterImportStep(chResourceFoo),
		},
		...
		Steps: []resource.TestStep{
			// Create ClickHouse Cluster
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(chResourceFoo, "name", chName),
					resource.TestCheckResourceAttr(chResourceFoo, "folder_id", folderID),
					resource.TestCheckResourceAttr(chResourceFoo, "version", chVersion),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.resources.0.resource_preset_id", firstStep.ResourcePresetId),
			...
			// Update ClickHouse version only
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(chResourceFoo, "name", chName),
					resource.TestCheckResourceAttr(chResourceFoo, "folder_id", folderID),
					resource.TestCheckResourceAttr(chResourceFoo, "version", chUpdatedVersion),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.resources.0.resource_preset_id", firstStep.ResourcePresetId),
			...
			{
				Config: testAccMDBClickHouseClusterResources(chName, "Cluster for TestAccMDBClickHouseCluster_ClusterResources", bucketName, rInt, chVersion, secondStep),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckMDBClickHouseClusterExists(chResourceFoo, &r, 1),
					resource.TestCheckResourceAttr(chResourceFoo, "name", chName),
					resource.TestCheckResourceAttr(chResourceFoo, "folder_id", folderID),
					resource.TestCheckResourceAttr(chResourceFoo, "version", chVersion),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.resources.0.resource_preset_id", secondStep.ResourcePresetId),
			...
			// Add host, creates implicit ZooKeeper subclusters
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(chResourceFoo, "security_group_ids.#", "1"),
					resource.TestCheckResourceAttrSet(chResourceFoo, "host.0.fqdn"),
					resource.TestCheckResourceAttrSet(chResourceFoo, "host.1.fqdn"),
		...
		Steps: []resource.TestStep{
			// Create ClickHouse Cluster with specify user settings
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(chResourceFoo, "name", chName),
					resource.TestCheckResourceAttr(chResourceFoo, "folder_id", folderID),
					resource.TestCheckResourceAttr(chResourceFoo, "user.0.generate_password", "true"),
					resource.TestCheckResourceAttr(chResourceFoo, "user.0.connection_manager.%", "1"),
					resource.TestCheckResourceAttr(chResourceFoo, "user.0.settings.0.max_concurrent_queries_for_user", "0"),
					resource.TestCheckResourceAttr(chResourceFoo, "user.0.settings.0.memory_profiler_step", "4194304"),
					resource.TestCheckResourceAttr(chResourceFoo, "user.0.settings.0.memory_profiler_sample_probability", "0"),
					resource.TestCheckResourceAttr(chResourceFoo, "user.0.settings.0.insert_null_as_default", "false"),
					resource.TestCheckResourceAttr(chResourceFoo, "user.0.settings.0.allow_suspicious_low_cardinality_types", "false"),
					resource.TestCheckResourceAttr(chResourceFoo, "user.0.settings.0.connect_timeout_with_failover", "50"),
					resource.TestCheckResourceAttr(chResourceFoo, "user.0.settings.0.allow_introspection_functions", "false"),
					resource.TestCheckResourceAttr(chResourceFoo, "user.0.settings.0.async_insert", "false"),
					resource.TestCheckResourceAttr(chResourceFoo, "user.0.settings.0.async_insert_threads", "16"),
					resource.TestCheckResourceAttr(chResourceFoo, "user.0.settings.0.wait_for_async_insert", "false"),
					resource.TestCheckResourceAttr(chResourceFoo, "user.0.settings.0.wait_for_async_insert_timeout", "1000"),
					resource.TestCheckResourceAttr(chResourceFoo, "user.0.settings.0.async_insert_max_data_size", "100000"),
					resource.TestCheckResourceAttr(chResourceFoo, "user.0.settings.0.async_insert_busy_timeout", "200"),
					resource.TestCheckResourceAttr(chResourceFoo, "user.0.settings.0.async_insert_stale_timeout", "1000"),
					resource.TestCheckResourceAttr(chResourceFoo, "user.0.settings.0.timeout_before_checking_execution_speed", "1000"),
					resource.TestCheckResourceAttr(chResourceFoo, "user.0.settings.0.cancel_http_readonly_queries_on_client_close", "false"),
					resource.TestCheckResourceAttr(chResourceFoo, "user.0.settings.0.flatten_nested", "false"),
					resource.TestCheckResourceAttr(chResourceFoo, "user.0.settings.0.format_regexp", "regexp1"),
					resource.TestCheckResourceAttr(chResourceFoo, "user.0.settings.0.format_regexp_skip_unmatched", "false"),
					resource.TestCheckResourceAttr(chResourceFoo, "user.0.settings.0.max_http_get_redirects", "0"),
					resource.TestCheckResourceAttr(chResourceFoo, "user.0.settings.0.max_final_threads", "0"),
					resource.TestCheckResourceAttr(chResourceFoo, "user.0.settings.0.input_format_import_nested_json", "false"),
					resource.TestCheckResourceAttr(chResourceFoo, "user.0.settings.0.input_format_parallel_parsing", "false"),
					resource.TestCheckResourceAttr(chResourceFoo, "user.0.settings.0.max_read_buffer_size", "1048576"),
					resource.TestCheckResourceAttr(chResourceFoo, "user.0.settings.0.local_filesystem_read_method", "pread"),
					resource.TestCheckResourceAttr(chResourceFoo, "user.0.settings.0.remote_filesystem_read_method", "read"),
					resource.TestCheckResourceAttr(chResourceFoo, "user.0.settings.0.insert_keeper_max_retries", "21"),
					resource.TestCheckResourceAttr(chResourceFoo, "user.0.settings.0.max_temporary_data_on_disk_size_for_user", "1048577"),
					resource.TestCheckResourceAttr(chResourceFoo, "user.0.settings.0.max_temporary_data_on_disk_size_for_query", "1048578"),
					resource.TestCheckResourceAttr(chResourceFoo, "user.0.settings.0.max_parser_depth", "1000"),
					resource.TestCheckResourceAttr(chResourceFoo, "user.0.settings.0.memory_overcommit_ratio_denominator", "1048579"),
					resource.TestCheckResourceAttr(chResourceFoo, "user.0.settings.0.memory_overcommit_ratio_denominator_for_user", "1048580"),
					resource.TestCheckResourceAttr(chResourceFoo, "user.0.settings.0.memory_usage_overcommit_max_wait_microseconds", "1048581"),
					resource.TestCheckResourceAttr(chResourceFoo, "user.0.settings.0.log_query_threads", "false"),
					resource.TestCheckResourceAttr(chResourceFoo, "user.0.settings.0.max_insert_threads", "10"),
					resource.TestCheckResourceAttr(chResourceFoo, "user.0.settings.0.use_hedged_requests", "false"),
					resource.TestCheckResourceAttr(chResourceFoo, "user.0.settings.0.idle_connection_timeout", "300000"),
					resource.TestCheckResourceAttr(chResourceFoo, "user.0.settings.0.load_balancing", "first_or_random"),
					resource.TestCheckResourceAttr(chResourceFoo, "user.0.settings.0.prefer_localhost_replica", "true"),
					resource.TestCheckResourceAttr(chResourceFoo, "user.0.settings.0.date_time_input_format", "best_effort"),
					resource.TestCheckResourceAttr(chResourceFoo, "user.0.settings.0.date_time_output_format", "simple"),
					resource.TestCheckResourceAttr(chResourceFoo, "user.0.settings.0.join_algorithm.#", "2"),
					resource.TestCheckResourceAttr(chResourceFoo, "user.0.settings.0.format_avro_schema_registry_url", "atest"),
					resource.TestCheckResourceAttr(chResourceFoo, "user.0.settings.0.data_type_default_nullable", "false"),
					resource.TestCheckResourceAttr(chResourceFoo, "user.0.settings.0.http_max_field_name_size", "2101"),
					resource.TestCheckResourceAttr(chResourceFoo, "user.0.settings.0.http_max_field_value_size", "2102"),
					resource.TestCheckResourceAttr(chResourceFoo, "user.0.settings.0.async_insert_use_adaptive_busy_timeout", "false"),
					resource.TestCheckResourceAttr(chResourceFoo, "user.0.settings.0.log_queries_probability", "0.5"),
					resource.TestCheckResourceAttr(chResourceFoo, "user.0.settings.0.log_processors_profiles", "false"),
					resource.TestCheckResourceAttr(chResourceFoo, "user.0.settings.0.use_query_cache", "false"),
					resource.TestCheckResourceAttr(chResourceFoo, "user.0.settings.0.enable_reads_from_query_cache", "false"),
					resource.TestCheckResourceAttr(chResourceFoo, "user.0.settings.0.enable_writes_to_query_cache", "false"),
					resource.TestCheckResourceAttr(chResourceFoo, "user.0.settings.0.query_cache_min_query_runs", "2201"),
					resource.TestCheckResourceAttr(chResourceFoo, "user.0.settings.0.query_cache_min_query_duration", "2202"),
					resource.TestCheckResourceAttr(chResourceFoo, "user.0.settings.0.query_cache_ttl", "2203"),
					resource.TestCheckResourceAttr(chResourceFoo, "user.0.settings.0.query_cache_max_entries", "2204"),
					resource.TestCheckResourceAttr(chResourceFoo, "user.0.settings.0.query_cache_max_size_in_bytes", "2205"),
					resource.TestCheckResourceAttr(chResourceFoo, "user.0.settings.0.query_cache_tag", "qtest"),
					resource.TestCheckResourceAttr(chResourceFoo, "user.0.settings.0.query_cache_share_between_users", "false"),
					resource.TestCheckResourceAttr(chResourceFoo, "user.0.settings.0.ignore_materialized_views_with_dropped_target_table", "false"),
					resource.TestCheckResourceAttr(chResourceFoo, "user.0.settings.0.enable_analyzer", "false"),
					resource.TestCheckResourceAttr(chResourceFoo, "user.0.settings.0.s3_use_adaptive_timeouts", "false"),
				),
			},
			mdbClickHouseClusterImportStep(chResourceFoo),
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(chResourceFoo, "user.0.generate_password", "true"),
					resource.TestCheckResourceAttr(chResourceFoo, "user.0.connection_manager.%", "1"),
					resource.TestCheckResourceAttr(chResourceFoo, "user.0.settings.0.max_concurrent_queries_for_user", "1"),
					resource.TestCheckResourceAttr(chResourceFoo, "user.0.settings.0.memory_profiler_step", "4194301"),
					resource.TestCheckResourceAttr(chResourceFoo, "user.0.settings.0.memory_profiler_sample_probability", "1"),
					resource.TestCheckResourceAttr(chResourceFoo, "user.0.settings.0.insert_null_as_default", "true"),
					resource.TestCheckResourceAttr(chResourceFoo, "user.0.settings.0.allow_suspicious_low_cardinality_types", "true"),
					resource.TestCheckResourceAttr(chResourceFoo, "user.0.settings.0.connect_timeout_with_failover", "51"),
					resource.TestCheckResourceAttr(chResourceFoo, "user.0.settings.0.allow_introspection_functions", "true"),
					resource.TestCheckResourceAttr(chResourceFoo, "user.0.settings.0.async_insert", "true"),
					resource.TestCheckResourceAttr(chResourceFoo, "user.0.settings.0.async_insert_threads", "17"),
					resource.TestCheckResourceAttr(chResourceFoo, "user.0.settings.0.wait_for_async_insert", "true"),
					resource.TestCheckResourceAttr(chResourceFoo, "user.0.settings.0.wait_for_async_insert_timeout", "2000"),
					resource.TestCheckResourceAttr(chResourceFoo, "user.0.settings.0.async_insert_max_data_size", "100001"),
					resource.TestCheckResourceAttr(chResourceFoo, "user.0.settings.0.async_insert_busy_timeout", "201"),
					resource.TestCheckResourceAttr(chResourceFoo, "user.0.settings.0.async_insert_stale_timeout", "1001"),
					resource.TestCheckResourceAttr(chResourceFoo, "user.0.settings.0.timeout_before_checking_execution_speed", "2000"),
					resource.TestCheckResourceAttr(chResourceFoo, "user.0.settings.0.cancel_http_readonly_queries_on_client_close", "true"),
					resource.TestCheckResourceAttr(chResourceFoo, "user.0.settings.0.flatten_nested", "true"),
					resource.TestCheckResourceAttr(chResourceFoo, "user.0.settings.0.format_regexp", "regexp2"),
					resource.TestCheckResourceAttr(chResourceFoo, "user.0.settings.0.format_regexp_skip_unmatched", "true"),
					resource.TestCheckResourceAttr(chResourceFoo, "user.0.settings.0.max_http_get_redirects", "1"),
					resource.TestCheckResourceAttr(chResourceFoo, "user.0.settings.0.max_final_threads", "1"),
					resource.TestCheckResourceAttr(chResourceFoo, "user.0.settings.0.input_format_import_nested_json", "true"),
					resource.TestCheckResourceAttr(chResourceFoo, "user.0.settings.0.input_format_parallel_parsing", "true"),
					resource.TestCheckResourceAttr(chResourceFoo, "user.0.settings.0.max_read_buffer_size", "1048578"),
					resource.TestCheckResourceAttr(chResourceFoo, "user.0.settings.0.local_filesystem_read_method", "read"),
					resource.TestCheckResourceAttr(chResourceFoo, "user.0.settings.0.remote_filesystem_read_method", "threadpool"),
					resource.TestCheckResourceAttr(chResourceFoo, "user.0.settings.0.insert_keeper_max_retries", "42"),
					resource.TestCheckResourceAttr(chResourceFoo, "user.0.settings.0.max_temporary_data_on_disk_size_for_user", "2048577"),
					resource.TestCheckResourceAttr(chResourceFoo, "user.0.settings.0.max_temporary_data_on_disk_size_for_query", "2048578"),
					resource.TestCheckResourceAttr(chResourceFoo, "user.0.settings.0.max_parser_depth", "2000"),
					resource.TestCheckResourceAttr(chResourceFoo, "user.0.settings.0.memory_overcommit_ratio_denominator", "2048579"),
					resource.TestCheckResourceAttr(chResourceFoo, "user.0.settings.0.memory_overcommit_ratio_denominator_for_user", "2048580"),
					resource.TestCheckResourceAttr(chResourceFoo, "user.0.settings.0.memory_usage_overcommit_max_wait_microseconds", "2048581"),
					resource.TestCheckResourceAttr(chResourceFoo, "user.0.settings.0.log_query_threads", "true"),
					resource.TestCheckResourceAttr(chResourceFoo, "user.0.settings.0.max_insert_threads", "0"),
					resource.TestCheckResourceAttr(chResourceFoo, "user.0.settings.0.use_hedged_requests", "true"),
					resource.TestCheckResourceAttr(chResourceFoo, "user.0.settings.0.idle_connection_timeout", "500000"),
					resource.TestCheckResourceAttr(chResourceFoo, "user.0.settings.0.load_balancing", "nearest_hostname"),
					resource.TestCheckResourceAttr(chResourceFoo, "user.0.settings.0.prefer_localhost_replica", "false"),
					resource.TestCheckResourceAttr(chResourceFoo, "user.0.settings.0.date_time_input_format", "basic"),
					resource.TestCheckResourceAttr(chResourceFoo, "user.0.settings.0.date_time_output_format", "iso"),
					resource.TestCheckResourceAttr(chResourceFoo, "user.0.settings.0.join_algorithm.#", "1"),
					resource.TestCheckResourceAttr(chResourceFoo, "user.0.settings.0.format_avro_schema_registry_url", "atest1"),
					resource.TestCheckResourceAttr(chResourceFoo, "user.0.settings.0.data_type_default_nullable", "true"),
					resource.TestCheckResourceAttr(chResourceFoo, "user.0.settings.0.http_max_field_name_size", "3101"),
					resource.TestCheckResourceAttr(chResourceFoo, "user.0.settings.0.http_max_field_value_size", "3102"),
					resource.TestCheckResourceAttr(chResourceFoo, "user.0.settings.0.async_insert_use_adaptive_busy_timeout", "true"),
					resource.TestCheckResourceAttr(chResourceFoo, "user.0.settings.0.log_queries_probability", "0.6"),
					resource.TestCheckResourceAttr(chResourceFoo, "user.0.settings.0.log_processors_profiles", "true"),
					resource.TestCheckResourceAttr(chResourceFoo, "user.0.settings.0.use_query_cache", "true"),
					resource.TestCheckResourceAttr(chResourceFoo, "user.0.settings.0.enable_reads_from_query_cache", "true"),
					resource.TestCheckResourceAttr(chResourceFoo, "user.0.settings.0.enable_writes_to_query_cache", "true"),
					resource.TestCheckResourceAttr(chResourceFoo, "user.0.settings.0.query_cache_min_query_runs", "3201"),
					resource.TestCheckResourceAttr(chResourceFoo, "user.0.settings.0.query_cache_min_query_duration", "3202"),
					resource.TestCheckResourceAttr(chResourceFoo, "user.0.settings.0.query_cache_ttl", "3203"),
					resource.TestCheckResourceAttr(chResourceFoo, "user.0.settings.0.query_cache_max_entries", "3204"),
					resource.TestCheckResourceAttr(chResourceFoo, "user.0.settings.0.query_cache_max_size_in_bytes", "3205"),
					resource.TestCheckResourceAttr(chResourceFoo, "user.0.settings.0.query_cache_tag", "qtest1"),
					resource.TestCheckResourceAttr(chResourceFoo, "user.0.settings.0.query_cache_share_between_users", "true"),
					resource.TestCheckResourceAttr(chResourceFoo, "user.0.settings.0.ignore_materialized_views_with_dropped_target_table", "true"),
					resource.TestCheckResourceAttr(chResourceFoo, "user.0.settings.0.enable_analyzer", "true"),
					resource.TestCheckResourceAttr(chResourceFoo, "user.0.settings.0.s3_use_adaptive_timeouts", "true"),
				),
			},
			mdbClickHouseClusterImportStep(chResourceFoo),
		},
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.log_level", "TRACE"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.max_connections", "512"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.max_concurrent_queries", "100"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.keep_alive_timeout", "123000"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.uncompressed_cache_size", "8096"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.mark_cache_size", "8096"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.max_table_size_to_drop", "1024"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.max_partition_size_to_drop", "1024"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.timezone", "UTC"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.query_log_retention_size", "1001"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.query_log_retention_time", "86400000"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.query_thread_log_enabled", "true"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.query_thread_log_retention_size", "1002"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.query_thread_log_retention_time", "86400000"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.part_log_retention_size", "1003"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.part_log_retention_time", "86400000"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.metric_log_enabled", "true"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.metric_log_retention_size", "1004"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.metric_log_retention_time", "86400000"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.trace_log_enabled", "true"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.trace_log_retention_size", "1005"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.trace_log_retention_time", "86400000"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.text_log_enabled", "true"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.text_log_retention_size", "1006"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.text_log_retention_time", "86400000"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.opentelemetry_span_log_enabled", "true"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.opentelemetry_span_log_retention_size", "1007"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.opentelemetry_span_log_retention_time", "86400000"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.query_views_log_enabled", "true"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.query_views_log_retention_size", "1008"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.query_views_log_retention_time", "86400000"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.asynchronous_metric_log_enabled", "true"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.asynchronous_metric_log_retention_size", "1009"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.asynchronous_metric_log_retention_time", "86400000"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.session_log_enabled", "true"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.session_log_retention_size", "1010"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.session_log_retention_time", "86400000"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.zookeeper_log_enabled", "true"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.zookeeper_log_retention_size", "1011"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.zookeeper_log_retention_time", "86400000"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.asynchronous_insert_log_enabled", "true"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.asynchronous_insert_log_retention_size", "1012"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.asynchronous_insert_log_retention_time", "86400000"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.text_log_level", "WARNING"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.background_pool_size", "16"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.background_schedule_pool_size", "32"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.background_fetches_pool_size", "8"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.background_move_pool_size", "8"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.background_distributed_schedule_pool_size", "8"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.background_buffer_flush_schedule_pool_size", "8"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.background_common_pool_size", "8"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.background_message_broker_schedule_pool_size", "9"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.background_merges_mutations_concurrency_ratio", "3"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.default_database", "default_db"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.total_memory_profiler_step", "4194304"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.dictionaries_lazy_load", "true"),

					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.merge_tree.0.replicated_deduplication_window", "1000"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.merge_tree.0.replicated_deduplication_window_seconds", "1000"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.merge_tree.0.parts_to_delay_insert", "110001"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.merge_tree.0.parts_to_throw_insert", "11001"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.merge_tree.0.inactive_parts_to_delay_insert", "101"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.merge_tree.0.inactive_parts_to_throw_insert", "110"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.merge_tree.0.max_replicated_merges_in_queue", "11000"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.merge_tree.0.number_of_free_entries_in_pool_to_lower_max_size_of_merge", "15"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.merge_tree.0.max_bytes_to_merge_at_min_space_in_pool", "11000"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.merge_tree.0.max_bytes_to_merge_at_max_space_in_pool", "16106127300"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.merge_tree.0.min_bytes_for_wide_part", "0"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.merge_tree.0.min_rows_for_wide_part", "0"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.merge_tree.0.ttl_only_drop_parts", "false"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.merge_tree.0.allow_remote_fs_zero_copy_replication", "false"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.merge_tree.0.merge_with_ttl_timeout", "100005"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.merge_tree.0.merge_with_recompression_ttl_timeout", "100006"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.merge_tree.0.max_parts_in_total", "100007"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.merge_tree.0.max_number_of_merges_with_ttl_in_pool", "1"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.merge_tree.0.cleanup_delay_period", "120"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.merge_tree.0.number_of_free_entries_in_pool_to_execute_mutation", "30"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.merge_tree.0.max_avg_part_size_for_too_many_parts", "100009"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.merge_tree.0.min_age_to_force_merge_seconds", "100010"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.merge_tree.0.min_age_to_force_merge_on_partition_only", "false"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.merge_tree.0.merge_selecting_sleep_ms", "5001"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.merge_tree.0.merge_max_block_size", "5001"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.merge_tree.0.check_sample_column_is_correct", "true"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.merge_tree.0.max_merge_selecting_sleep_ms", "50001"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.merge_tree.0.max_cleanup_delay_period", "201"),

					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.kafka.0.security_protocol", "SECURITY_PROTOCOL_PLAINTEXT"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.kafka.0.sasl_mechanism", "SASL_MECHANISM_GSSAPI"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.kafka.0.sasl_username", "user1"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.kafka.0.sasl_password", "pass1"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.kafka.0.debug", "DEBUG_GENERIC"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.kafka.0.auto_offset_reset", "AUTO_OFFSET_RESET_SMALLEST"),

					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.kafka_topic.#", "2"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.kafka_topic.0.name", "topic1"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.kafka_topic.0.settings.0.security_protocol", "SECURITY_PROTOCOL_SSL"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.kafka_topic.0.settings.0.sasl_mechanism", "SASL_MECHANISM_SCRAM_SHA_256"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.kafka_topic.0.settings.0.sasl_username", "user2"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.kafka_topic.0.settings.0.sasl_password", "pass21"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.kafka_topic.0.settings.0.enable_ssl_certificate_verification", "false"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.kafka_topic.0.settings.0.max_poll_interval_ms", "50001"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.kafka_topic.0.settings.0.session_timeout_ms", "50002"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.kafka_topic.0.settings.0.debug", "DEBUG_BROKER"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.kafka_topic.0.settings.0.auto_offset_reset", "AUTO_OFFSET_RESET_EARLIEST"),

					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.kafka_topic.1.name", "topic2"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.kafka_topic.1.settings.0.security_protocol", "SECURITY_PROTOCOL_PLAINTEXT"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.kafka_topic.1.settings.0.sasl_mechanism", "SASL_MECHANISM_PLAIN"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.kafka_topic.1.settings.0.sasl_username", "user2"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.kafka_topic.1.settings.0.sasl_password", "pass22"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.kafka_topic.1.settings.0.enable_ssl_certificate_verification", "true"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.kafka_topic.1.settings.0.max_poll_interval_ms", "0"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.kafka_topic.1.settings.0.session_timeout_ms", "0"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.kafka_topic.1.settings.0.debug", "DEBUG_TOPIC"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.kafka_topic.1.settings.0.auto_offset_reset", "AUTO_OFFSET_RESET_BEGINNING"),

					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.rabbitmq.0.username", "rabbit_user"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.rabbitmq.0.password", "rabbit_pass"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.rabbitmq.0.vhost", "old_clickhouse"),

					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.graphite_rollup.#", "1"),

					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.query_masking_rules.#", "1"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.query_masking_rules.0.name", "name1"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.query_masking_rules.0.regexp", "regexp1"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.query_masking_rules.0.replace", "replace1"),

					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.query_cache.0.max_size_in_bytes", "1073741820"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.query_cache.0.max_entries", "1020"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.query_cache.0.max_entry_size_in_bytes", "1048570"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.query_cache.0.max_entry_size_in_rows", "20000000"),

					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.jdbc_bridge.0.host", "127.0.0.2"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.jdbc_bridge.0.port", "8999"),
			...
			mdbClickHouseClusterImportStep(chResourceFoo),
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.log_level", "WARNING"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.max_connections", "1024"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.max_concurrent_queries", "200"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.keep_alive_timeout", "246000"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.uncompressed_cache_size", "16192"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.mark_cache_size", "16192"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.max_table_size_to_drop", "2048"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.max_partition_size_to_drop", "2048"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.timezone", "UTC"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.query_log_retention_size", "2001"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.query_log_retention_time", "86400000"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.query_thread_log_enabled", "true"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.query_thread_log_retention_size", "2002"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.query_thread_log_retention_time", "86400000"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.part_log_retention_size", "2003"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.part_log_retention_time", "86400000"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.metric_log_enabled", "true"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.metric_log_retention_size", "2004"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.metric_log_retention_time", "86400000"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.trace_log_enabled", "true"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.trace_log_retention_size", "2005"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.trace_log_retention_time", "86400000"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.text_log_enabled", "true"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.text_log_retention_size", "2006"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.text_log_retention_time", "86400000"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.opentelemetry_span_log_enabled", "true"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.opentelemetry_span_log_retention_size", "2007"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.opentelemetry_span_log_retention_time", "86400000"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.query_views_log_enabled", "true"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.query_views_log_retention_size", "2008"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.query_views_log_retention_time", "86400000"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.asynchronous_metric_log_enabled", "true"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.asynchronous_metric_log_retention_size", "2009"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.asynchronous_metric_log_retention_time", "86400000"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.session_log_enabled", "true"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.session_log_retention_size", "2010"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.session_log_retention_time", "86400000"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.zookeeper_log_enabled", "true"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.zookeeper_log_retention_size", "2011"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.zookeeper_log_retention_time", "86400000"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.asynchronous_insert_log_enabled", "true"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.asynchronous_insert_log_retention_size", "2012"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.asynchronous_insert_log_retention_time", "86400000"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.text_log_level", "ERROR"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.background_pool_size", "32"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.background_schedule_pool_size", "64"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.background_fetches_pool_size", "16"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.background_move_pool_size", "16"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.background_distributed_schedule_pool_size", "16"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.background_buffer_flush_schedule_pool_size", "16"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.background_common_pool_size", "16"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.background_message_broker_schedule_pool_size", "17"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.background_merges_mutations_concurrency_ratio", "4"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.default_database", "new_default"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.total_memory_profiler_step", "4194303"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.dictionaries_lazy_load", "false"),

					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.merge_tree.0.replicated_deduplication_window", "100"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.merge_tree.0.replicated_deduplication_window_seconds", "604800"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.merge_tree.0.parts_to_delay_insert", "150"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.merge_tree.0.parts_to_throw_insert", "12000"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.merge_tree.0.inactive_parts_to_delay_insert", "102"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.merge_tree.0.inactive_parts_to_throw_insert", "120"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.merge_tree.0.max_replicated_merges_in_queue", "16"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.merge_tree.0.number_of_free_entries_in_pool_to_lower_max_size_of_merge", "8"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.merge_tree.0.max_bytes_to_merge_at_min_space_in_pool", "1048576"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.merge_tree.0.max_bytes_to_merge_at_max_space_in_pool", "16106127301"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.merge_tree.0.min_bytes_for_wide_part", "512"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.merge_tree.0.min_rows_for_wide_part", "16"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.merge_tree.0.ttl_only_drop_parts", "true"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.merge_tree.0.allow_remote_fs_zero_copy_replication", "true"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.merge_tree.0.merge_with_ttl_timeout", "200010"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.merge_tree.0.merge_with_recompression_ttl_timeout", "200012"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.merge_tree.0.max_parts_in_total", "200014"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.merge_tree.0.max_number_of_merges_with_ttl_in_pool", "2"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.merge_tree.0.cleanup_delay_period", "240"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.merge_tree.0.number_of_free_entries_in_pool_to_execute_mutation", "40"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.merge_tree.0.max_avg_part_size_for_too_many_parts", "200018"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.merge_tree.0.min_age_to_force_merge_seconds", "200020"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.merge_tree.0.min_age_to_force_merge_on_partition_only", "true"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.merge_tree.0.merge_selecting_sleep_ms", "5002"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.merge_tree.0.merge_max_block_size", "5002"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.merge_tree.0.check_sample_column_is_correct", "false"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.merge_tree.0.max_merge_selecting_sleep_ms", "100001"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.merge_tree.0.max_cleanup_delay_period", "401"),

					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.kafka.0.security_protocol", "SECURITY_PROTOCOL_PLAINTEXT"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.kafka.0.sasl_mechanism", "SASL_MECHANISM_GSSAPI"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.kafka.0.sasl_username", "user1"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.kafka.0.sasl_password", "pass1"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.kafka.0.debug", "DEBUG_METADATA"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.kafka.0.auto_offset_reset", "AUTO_OFFSET_RESET_LARGEST"),

					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.kafka_topic.#", "3"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.kafka_topic.0.name", "topic1"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.kafka_topic.0.settings.0.security_protocol", "SECURITY_PROTOCOL_SSL"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.kafka_topic.0.settings.0.sasl_mechanism", "SASL_MECHANISM_SCRAM_SHA_256"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.kafka_topic.0.settings.0.sasl_username", "user2"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.kafka_topic.0.settings.0.sasl_password", "pass21"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.kafka_topic.0.settings.0.enable_ssl_certificate_verification", "true"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.kafka_topic.0.settings.0.max_poll_interval_ms", "60001"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.kafka_topic.0.settings.0.session_timeout_ms", "60002"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.kafka_topic.0.settings.0.debug", "DEBUG_FEATURE"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.kafka_topic.0.settings.0.auto_offset_reset", "AUTO_OFFSET_RESET_LATEST"),
					...
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.kafka_topic.1.settings.0.sasl_username", "user2"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.kafka_topic.1.settings.0.sasl_password", "pass22"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.kafka_topic.1.settings.0.enable_ssl_certificate_verification", "false"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.kafka_topic.1.settings.0.max_poll_interval_ms", "0"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.kafka_topic.1.settings.0.session_timeout_ms", "0"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.kafka_topic.1.settings.0.debug", "DEBUG_QUEUE"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.kafka_topic.1.settings.0.auto_offset_reset", "AUTO_OFFSET_RESET_END"),

					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.kafka_topic.2.name", "topic3"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.kafka_topic.2.settings.0.security_protocol", "SECURITY_PROTOCOL_SASL_PLAINTEXT"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.kafka_topic.2.settings.0.sasl_mechanism", "SASL_MECHANISM_SCRAM_SHA_512"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.kafka_topic.2.settings.0.sasl_username", "user3"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.kafka_topic.2.settings.0.sasl_password", "pass23"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.kafka_topic.2.settings.0.enable_ssl_certificate_verification", "false"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.kafka_topic.2.settings.0.max_poll_interval_ms", "0"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.kafka_topic.2.settings.0.session_timeout_ms", "0"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.kafka_topic.2.settings.0.debug", "DEBUG_MSG"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.kafka_topic.2.settings.0.auto_offset_reset", "AUTO_OFFSET_RESET_ERROR"),

					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.rabbitmq.0.username", "rabbit_user"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.rabbitmq.0.password", "rabbit_pass2"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.rabbitmq.0.vhost", "clickhouse"),

					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.compression.#", "2"),

					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.query_masking_rules.#", "2"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.query_masking_rules.0.name", "name11"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.query_masking_rules.0.regexp", "regexp11"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.query_masking_rules.0.replace", "replace11"),

					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.query_masking_rules.1.regexp", "regexp22"),

					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.query_cache.0.max_size_in_bytes", "2073741820"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.query_cache.0.max_entries", "2020"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.query_cache.0.max_entry_size_in_bytes", "2048570"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.query_cache.0.max_entry_size_in_rows", "30000000"),

					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.jdbc_bridge.0.host", "127.0.0.3"),
					resource.TestCheckResourceAttr(chResourceFoo, "clickhouse.0.config.0.jdbc_bridge.0.port", "8998"),
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			// Create ClickHouse Cluster with disk encryption
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckMDBClickHouseClusterExists(chResourceFoo, &r, 1),
					resource.TestCheckResourceAttrSet(chResourceFoo, "disk_encryption_key_id"),
				),
			},
			mdbClickHouseClusterImportStep(chResourceFoo),
		},
